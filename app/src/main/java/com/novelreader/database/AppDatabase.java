...
@Database(entities = {AppDatabase.NovelEntity.class,
        AppDatabase.ChapterEntity.class,
        AppDatabase.BookmarkEntity.class,
        AppDatabase.ReadingStatsEntity.class},
        version = 1, exportSchema = false)
@TypeConverters(AppDatabase.Converters.class)
public abstract class AppDatabase extends RoomDatabase {

    @Entity(tableName = "novels")
    public static class NovelEntity {
        @PrimaryKey
        public int id;
        public String title;
    ...
    public static class ReadingStatsEntity {
        @PrimaryKey
        public int novelId;
    ...
    @Dao
    public static interface NovelDao {
    ...
    @Dao
    public static interface ChapterDao {
    ...
    @Dao
    public static interface BookmarkDao {
    ...
    @Dao
    public static interface ReadingStatsDao {
